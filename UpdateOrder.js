...
function UpdateOrder() {
    return (
        <div className="mx-5 lg:w-1/2 lg:mx-auto my-10 shadow-md sm:rounded-lg py-3">
            <h1 className="text-4xl font-bold text-center my-8 text-nile-blue-900">Update Order</h1>
            <div className="mx-10">
                <form action="">
                    ...
                    <div className="md:flex md:justify-around">
                        ...
                        <div>
                            <label className="pb-1 text-nile-blue-600" htmlFor="statusOrder">Status Number</label>
                            <select className="bg-nile-blue-50 border border-nile-blue-500 text-sm rounded-lg focus:ring-nile-blue-500 focus:border-nile-blue-700 block w-full p-2.5" name="statusOrder" id="statusOrder">
                                <option selected>Choose a Option</option>
                                <option value="Processing">Cancelled</option>
                                <option value="Pending">Done</option>
                                <option value="On the way">Saved</option>
                            </select>
                            </div>
                    </div>
